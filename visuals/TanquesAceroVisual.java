...
public class TanquesAceroVisual extends JFrame {
	...
	private InventarioTanquesAcero informe=null;
	...
	public TanquesAceroVisual(InventarioTanquesAcero informe)  {
		super();
	...
	private void initialize() {
	    ...
	    this.setTitle("ESTADO DE TANQUES DE ACERO INOXIDABLE EN PRODUCCIÓN");
		...
		LinkedList<TanqueAcero> listD = new LinkedList<TanqueAcero>();
		listD = ServicioTanquesAcero.getTanques(informe.getId_inventarioAcero());
		...
		for (int i = 0; i < listD.size(); i++) {
			...
			columnDataCapacidad.add(listD.get(i).getCapacidad());
		...
		defaultTableModel.addColumn("CAPACIDAD LTS",columnDataCapacidad.toArray());
		defaultTableModel.addColumn("PRODUCTO", columnDataProducto.toArray());
		defaultTableModel.addColumn("GRADO",columnDataGrado.toArray());
		defaultTableModel.addColumn("LTS. REALES", columnDataLTSReales.toArray());
		...
		jTable.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent e) {
				...
				LinkedList<TanqueAcero> users = ServicioTanquesAcero.getTanques(informe.getId_inventarioAcero());
				TanqueAcero u = users.get(pos);
				...
				CapacidadjTextField.setText(String.valueOf(u.getCapacidad()));
	...
	private JSpinner getDatejSpinner() {
		if (DatejSpinner == null) {
			...
			DatejSpinner.setValue(informe.getFechaAcero());
	...
	private JSpinner getDatejSpinnerInicio() {
		if (DatejSpinnerInicio == null) {
			...
			DatejSpinnerInicio.setBounds(new Rectangle(15, 50, 90, 29));
			}
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(LTSjTextField.getText().length()!=0 && GradosjTextField.getText().length()!=0
						...
						if(SIjRadioButton.isSelected()){
							try {
								try {
									ServicioTanquesAcero.insertarTanqueAcero(tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), Float.valueOf(GradosjTextField.getText()), Integer.valueOf(LTSjTextField.getText()), sqlDateInicio, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente(), Integer.valueOf(OFjTextField.getText()), informe.getId_inventarioAcero());
									JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Insertado", "Información", JOptionPane.INFORMATION_MESSAGE);
								} catch (SQLException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
								} catch (ClassNotFoundException e1) {
						...
						if(NojRadioButton.isSelected()){
							try {
								try {
									ServicioTanquesAcero.insertarTanqueAcero(tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), Float.valueOf(GradosjTextField.getText()), Integer.valueOf(LTSjTextField.getText()), null, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente(), Integer.valueOf(OFjTextField.getText()), informe.getId_inventarioAcero());
									JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Insertado", "Información", JOptionPane.INFORMATION_MESSAGE);
								} catch (SQLException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
					...
					if(LTSjTextField.getText().length()==0 && GradosjTextField.getText().length()==0
						...
						if(SIjRadioButton.isSelected()){
							try {
								try {
									ServicioTanquesAcero.insertarTanqueAcerosinOFniGradoniLTS(tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), sqlDateInicio, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente(), informe.getId_inventarioAcero());
									JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Insertado", "Información", JOptionPane.INFORMATION_MESSAGE);
								} catch (SQLException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
						...
						if(NojRadioButton.isSelected()){
							try {
								try {
									ServicioTanquesAcero.insertarTanqueAcerosinOFniGradoniLTS(tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), null, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente(), informe.getId_inventarioAcero());
									JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Insertado", "Información", JOptionPane.INFORMATION_MESSAGE);
								} catch (SQLException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
					...
					if(LTSjTextField.getText().length()!=0 && GradosjTextField.getText().length()!=0
						...
						if(SIjRadioButton.isSelected()){
							try {
								try {
									ServicioTanquesAcero.insertarTanqueAcerosinOF(tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), Float.valueOf(GradosjTextField.getText()), Integer.valueOf(LTSjTextField.getText()), sqlDateInicio, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente(), informe.getId_inventarioAcero());
									JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Insertado", "Información", JOptionPane.INFORMATION_MESSAGE);
								} catch (SQLException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
						...
						if(NojRadioButton.isSelected()){
							try {
								try {
									ServicioTanquesAcero.insertarTanqueAcerosinOF(tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), Float.valueOf(GradosjTextField.getText()), Integer.valueOf(LTSjTextField.getText()), null, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente(), informe.getId_inventarioAcero());
									JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Insertado", "Información", JOptionPane.INFORMATION_MESSAGE);
								} catch (SQLException e1) {
									// TODO Auto-generated catch block
									e1.printStackTrace();
						...
						JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Debe Seleccionar los Combos", "Información", JOptionPane.INFORMATION_MESSAGE);
					}
	...
	private JButton getModificarjButton() {
		if (ModificarjButton == null) {
			...
			ModificarjButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					int result = JOptionPane.showConfirmDialog(TanquesAceroVisual.this, "¿Está seguro que desea modificar el Registro?", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
					...
					TanqueAcero u = users.get(pos);	
					try {
						ServicioTanquesAcero.ModificarTanquesAcero(u.getId_tanque(), tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), Float.valueOf(GradosjTextField.getText()), Integer.valueOf(LTSjTextField.getText()), sqlDateInicio, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente(), Integer.valueOf(OFjTextField.getText()));
						JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Modificado", "Información", JOptionPane.INFORMATION_MESSAGE);
					...
					TanqueAcero u = users.get(pos);	
					try {
						ServicioTanquesAcero.ModificarTanquesAcerosinOFniGradoniLTS(u.getId_tanque(), tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), sqlDateInicio, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente());
						JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Modificado", "Información", JOptionPane.INFORMATION_MESSAGE);
					} catch (NumberFormatException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					...
					UserInterfaceSuport.clearComponents(jPanel);
						...
						TanqueAcero u = users.get(pos);	
						try {
							ServicioTanquesAcero.ModificarTanquesAcerosinOFniGradoniLTS(u.getId_tanque(), tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), null, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente());
							JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Modificado", "Información", JOptionPane.INFORMATION_MESSAGE);
						} catch (NumberFormatException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
					...
					TanqueAcero u = users.get(pos);	
					try {
						ServicioTanquesAcero.ModificarTanquesAcerosinOF(u.getId_tanque(), tjTextField.getText(), Integer.valueOf(CapacidadjTextField.getText()), ((Producto)getProductojComboBox().getSelectedItem()).getId_producto(), Float.valueOf(GradosjTextField.getText()), Integer.valueOf(LTSjTextField.getText()), sqlDateInicio, ((Cliente)getClientejComboBox().getSelectedItem()).getId_cliente());
						JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Modificado", "Información", JOptionPane.INFORMATION_MESSAGE);
					} catch (NumberFormatException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					...
					UserInterfaceSuport.clearComponents(jPanel);
						...
						UserInterfaceSuport.clearComponents(jPanel);
							...
							JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Debe Llenar todos los Combos", "Información", JOptionPane.ERROR_MESSAGE);	
						}
					InsertarjButton.setEnabled(true);
					EliminarjButton.setEnabled(false);
					ModificarjButton.setEnabled(false);
	...
	private JButton getEliminarjButton() {
		if (EliminarjButton == null) {
			...
			EliminarjButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					int result = JOptionPane.showConfirmDialog(TanquesAceroVisual.this, "¿Está seguro que desea Eliminar el Registro?", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
					if(result == JOptionPane.YES_OPTION){
					int pos = jTable.getSelectedRow();
					try {
						LinkedList<TanqueAcero> users = ServicioTanquesAcero.getTanques(informe.getId_inventarioAcero());
						TanqueAcero u = users.get(pos);
						ServicioTanquesAcero.EliminarTanquesAcero(u.getId_tanque());
						JOptionPane.showMessageDialog(TanquesAceroVisual.this, "Registro Eliminado", "Información", JOptionPane.INFORMATION_MESSAGE);
						InsertarjButton.setEnabled(true);
						DecimalFormatSymbols simbolo=new DecimalFormatSymbols();
					    simbolo.setDecimalSeparator(',');
					    simbolo.setGroupingSeparator('.');
	...
	private JButton getRegresarjButton() {
		if (regresarjButton == null) {
			...
			regresarjButton.setBounds(new Rectangle(465, 217, 288, 36));
			regresarjButton.setText("Listado Inventario de Tanques de Acero");
	...
	private JButton getMenujButton() {
		if (MenujButton == null) {
			...
			MenujButton.setBounds(new Rectangle(765, 217, 146, 36));
	...
	private JButton getImprimirjButton() {
		if (ImprimirjButton == null) {
			...
			ImprimirjButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					try {
						Reportes.getR().InventarioTanquesAcero(informe.getId_inventarioAcero());
